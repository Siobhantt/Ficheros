...
public class Ej6Main {
	...
	public static void main(String[] args) {
		//la lista la usaremos de enteros para que se ordene, ya intente hacerlo de string y no funcionó
		...
		try {
			...
			Scanner lee = new Scanner(new FileReader("Numeros.txt"));//para leer del fichero numeros donde hay un desorden montado
	...
	//una vez leidos todos los numeros y almacenados en la lista
			for(int num:lista) {//recorro la lista
				numCa= Integer.toString(num);//y voy pasando en orden(Poruqe la lista ya esta ordenada) los numeros a cadena
